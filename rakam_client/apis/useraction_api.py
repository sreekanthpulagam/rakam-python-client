...
class UseractionApi(object):
    ...
    def batch(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.batch(user_email_action_batch=user_email_action_batch_value, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.batch_with_http_info(**kwargs)
        else:
            (data) = self.batch_with_http_info(**kwargs)
            return data

    def batch_with_http_info(self, **kwargs):
        """
        Apply batch operation
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.batch_with_http_info(user_email_action_batch=user_email_action_batch_value, callback=callback_function)
        ...
        if ('user_email_action_batch' not in params) or (params['user_email_action_batch'] is None):
            raise ValueError("Missing the required parameter `user_email_action_batch` when calling `batch`")
    ...
    def send(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.send(user_email_action_send=user_email_action_send_value, callback=callback_function)
    ...
    def send_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.send_with_http_info(user_email_action_send=user_email_action_send_value, callback=callback_function)
        ...
        if ('user_email_action_send' not in params) or (params['user_email_action_send'] is None):
            raise ValueError("Missing the required parameter `user_email_action_send` when calling `send`")
