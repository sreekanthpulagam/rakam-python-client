...
from rakam_client.apis.continuousquery_api import ContinuousqueryApi


class TestContinuousqueryApi(unittest.TestCase):
    """ ContinuousqueryApi unit test stubs """

    def setUp(self):
        self.api = rakam_client.apis.continuousquery_api.ContinuousqueryApi()
    ...
    def test_get_schema_of_query(self):
        """
        Test case for get_schema_of_query
